...
$splat.Add('owner', $originUrl.Split('/')[-2])
$splat.Add('repositoryName', $originUrl.Split('/')[-1].Split('.')[0])
$splat.Add('branch', $(git symbolic-ref HEAD).split('/')[-1])
Set-GitHubRepositoryDispatch @splat
